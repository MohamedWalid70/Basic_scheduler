...
void main(void){
	...
	SCHED_enumAddTask(&led_toggle1,1000,0,1);
	SCHED_enumAddTask(&led_toggle2,2000,1,2);
	SCHED_enumAddTask(&led_toggle3,3000,2,3);
	SCHED_enumAddTask(&led_toggle4,4000,3,4);
	SCHED_enumAddTask(&led_toggle5,5000,4,5);
